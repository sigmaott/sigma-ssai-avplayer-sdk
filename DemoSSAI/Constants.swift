...
struct Constants {
    ...
    static let hlsSCTE35 = "\(baseDomain)/manifest/origin04/scte35-video-audio-clear/master.m3u8"
    static let hlsTs2s = "\(baseDomain)/manifest/origin04/scte35-av2s-clear/master.m3u8"
    static let hlsTs4s = "\(baseDomain)/manifest/origin04/scte35-av4s-clear/master.m3u8"
    static let hlsTs6s = "\(baseDomain)/manifest/origin04/scte35-av6s-clear/master.m3u8"
    static let ANTV = "http://live-on-v2-akm.akamaized.net/manifest/test_live/master.m3u8"
